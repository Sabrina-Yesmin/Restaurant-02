				...
				<div class="col-md-9 clearfix">
					<ul class="blog-zone">
					    <li>
					        ...
					        <div class="blog-box">
					        	<img src="{{asset('website/images/blog-1.jpg')}}" alt="">
					...
					<div class="author-id">
						<div class="media">
							<h5>About The Author</h5>
						  	<img class="media-object pull-left" src="{{asset('website/images/author.jpg')}}" alt="...">
							...
							<ul class="media-list">
							 	<li class="media">
							    	<a class="pull-left" href="#">
							      		<img class="media-object" src="{{asset('website/images/post-img.png')}}" alt="...">
							    	</a>
							    	<div class="media-body">
							  	...
							  	<li class="media">
							    	<a class="pull-left" href="#">
							      		<img class="media-object" src="{{asset('website/images/post-img-2.png')}}" alt="...">
							    	</a>
							    	<div class="media-body">
							      		<a href="" class="media-heading">
							  	...
							  	<li class="media">
							    	<a class="pull-left" href="#">
							      		<img class="media-object')}}" src="{{asset('website/images/post-img-3.png')}}" alt="...">
							    	</a>
							    	<div class="media-body">
							      		<a href="" class="media-heading">
...
<!-- Css -->
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/nivo-slider.css" type="text/css" />
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/owl.carousel.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/owl.theme.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/bootstrap.min.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/font-awesome.min.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/style.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/website/css/responsive.css">

<!-- jS -->
<script src="{{asset('website/http://127.0.0.1:8000/website/js/jquery.min.js ')}}" type="text/javascript"></script>
<script src="{{asset('website/http://127.0.0.1:8000/website/js/bootstrap.min.js')}} " type="text/javascript"></script>
<script src="{{asset('website/http://127.0.0.1:8000/website/js/jquery.nivo.slider.js')}} " type="text/javascript"></script>
<script src="{{asset('website/http://127.0.0.1:8000/website/js/owl.carousel.min.js')}} " type="text/javascript"></script>
<script src="{{asset('website/http://127.0.0.1:8000/website/js/jquery.nicescroll.js')}} "></script>
<script src="{{asset('website/http://127.0.0.1:8000/website/js/jquery.scrollUp.min.js')}} "></script>
<script src="{{asset('website/http://127.0.0.1:8000/website/js/main.js ')}}" type="text/javascript"></script>
@stop
